...
"""Награда за изменение вариационной маржи и прибыл/убыток от сделки + общая прибыль в конце (1.057, 1.052 / 1.057, 0.92)"""
...
class CryptoEnvV4(gym.Env):
    ...
    def step(self, action):
        ...
        if any([self.done, self.truncated]): #если конец
            ...
            step_reward += self.account - self.initial_account
